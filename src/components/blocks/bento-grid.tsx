...
export function BentoGrid({ className, ...props }: BentoGridProps = {}) {
  return (
    <section 
      className={cn("w-full py-20 md:py-28 px-6 relative z-20 bg-[var(--background)]/30 backdrop-blur-lg border-b border-[var(--border)]", className)} 
      id="capabilities"
      {...props}
    >
      <div className="max-w-screen-xl mx-auto flex flex-col justify-center">
        ...
        >
          ...
          <h3 className="max-w-3xl text-3xl md:text-5xl font-semibold tracking-tight text-[var(--foreground)] mb-12 sm:mb-16">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-12">
          <BentoCard
            ...
            large
            graphic={
              <div className="w-full h-44 rounded-xl bg-[var(--surface-muted)] border border-[var(--border)] p-4 flex flex-col justify-between font-mono text-xs text-[var(--foreground)] overflow-hidden">
                <div className="flex items-center justify-between border-b border-[var(--border)] pb-2">
                  ...
                  <span className="text-[10px] text-[var(--foreground-muted)] truncate">ArchitectureSpec.ts</span>
                </div>
                <div className="space-y-1.5 py-2">
                  <p className="text-[var(--accent)] font-medium truncate text-[11px] sm:text-xs">&lt;PWAProvider offlineFallback=&#123;true&#125; /&gt;</p>
                  <p className="text-[var(--foreground-muted)] truncate text-[11px] sm:text-xs">const targetFPS = 60; // Zero jank</p>
          ...
          <BentoCard
            ...
            graphic={
              <div className="w-full h-24 rounded-xl bg-[var(--surface-muted)] border border-[var(--border)] p-3 flex items-center justify-around">
                ...
                <div className="w-16 h-12 rounded-lg bg-[var(--accent)] shadow-2xs p-2 flex flex-col justify-center items-center text-[var(--accent-foreground)]">
